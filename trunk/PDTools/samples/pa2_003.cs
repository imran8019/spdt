...
{ 
 ...
 { 
 // This constructor initializes all data fields contained 
 ...
 // Gets the interger component of a real number. 
 latitudeDegrees=(int) latitude; 
 
 //Gets the fractional component of the real number. 
 ...
 // represent the longitude of a location in DMS format 
 
 //The value of parameters d1,m1,s1 are assigned to latitudeDegrees, 
 //latitudeMinutes and latitudeSeconds respectively. 
 latitudeDegrees=d1; 
 latitudeMinutes=m1; 
 latitudeSeconds=s1; 
 
 //The value of parameters d1,m1,s1 are assigned to longitudeDegrees, 
 //longitudeMinutes and longitudeSeconds respectively. 
 longitudeDegrees=d2; 
 longitudeMinutes=m2; 
 longitudeSeconds=s2; 
 } 
 ...
 { 
 // This property returns a decimal degrees representation 
 // of the latitude data fields contained within an instance of a 
 // GeographicLocation object. The value is returned in units 
 // of radians. 
 
 get 
 { 
 if(latitudeDegrees<0) 
 //Latitude specifying a location in the southern hemisphere 
 { 
 //Converts Latitude degrees to radians 
 return (latitudeDegrees+(latitudeMinutes/60d)+(latitudeSeconds/3600d)) 
 *Math.PI/180; 
 } 
 else//Latitude specifying a location in the northern hemisphere 
 { 
 //Converts Latitude degrees to radians 
 return (latitudeDegrees-(latitudeMinutes/60d)-(latitudeSeconds/3600d)) 
 *Math.PI/180; 
 ...
 // GeographicLocation object. The value returned is in units 
 // of radians. 
 get 
 { 
 if(longitudeDegrees<0) 
 //Longitude specifying a location in the western hemisphere 
 { 
 //Converts Longitude degrees to radians 
 return (longitudeDegrees+(longitudeMinutes/60d)+ 
 (longitudeSeconds/3600d))*Math.PI/180; 
 } 
 else //Longitude specifying a location in the eastern hemisphere 
 { 
 //converts Longitude degrees to radians 
 return (longitudeDegrees-(longitudeMinutes/60d)-(longitudeSeconds/3600d)) 
 *Math.PI/180; 
 } 
 } 
 ...
 { 
 // This instance method returns a string representation of the 
 // data fields contained within an instance of a GeographicLocation 
 // object. 
 
 // Created char variables 
 char northOrSouth; 
 char eastOrWest; 
 ...
 //Latitude specifying a location in the southern hemisphere 
 { 
 northOrSouth='S';//Output the letter 'S'. 
 } 
 else 
 //Latitude specifying a location in the northern hemisphere 
 { 
 northOrSouth='N';//Output the letter 'N'. 
 } 
 
 if (longitudeDegrees>0) 
 //Longitude specifying a location in the eastern hemisphere 
 { 
 eastOrWest='E';//Output the letter 'E'. 
 } 
 else 
 //Longitude specifying a location in the western hemisphere 
 { 
 eastOrWest='W';//Output the letter 'W'. 
 } 
 
 return string.Format("{0}\u00b0{1}'{2}\"{3} {4}\u00b0{5}'{6}\"{7}", 
 Math.Abs(latitudeDegrees),latitudeMinutes,latitudeSeconds,northOrSouth, 
 Math.Abs(longitudeDegrees),longitudeMinutes,longitudeSeconds,eastOrWest); 
...
{ 
 ...
 { 
 // This method obtains an unsigned integer value within 
 // the specified range from a user via the console window. 
 ...
 Console.WriteLine("\nEnter the {0} of the {1} ranging", 
 units, measurement); 
 Console.Write(" from 0\" to {0}\" as an unsigned integer: ",max); 
