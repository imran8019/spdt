...
{ 
 ...
 private double latitudeRadians; // decimal representation in radians 
 private char NShemisphere; // hemisphere of the earth North or South 
 ...
 private double longitudeRadians; //decimal representation in radians 
 private char EWhemisphere; // hemisphere of the earth East or West 
 ...
 getHemisphere("latitude", latitudeDegrees); 
 
 longitudeDegrees = (int)longitude; 
 latitudeMinutes = (uint)((longitude - longitudeDegrees) * 60); 
 longitudeSeconds = (uint)(((longitude - longitudeDegrees) * 60) - longitudeMinutes) * 60; 
 getHemisphere("longitude", longitudeDegrees); 
 ...
 public void getHemisphere(string value,int degree) 
 { 
 // This function determines the hemisphere of the Earth 
 // that the value of the latitude or longitude corresponds to. 
 ...
 get 
 { 
 return ((double)latitudeDegrees + ((double)latitudeMinutes / 60) + 
 ((double)latitudeSeconds / 3600)) * (Math.PI / 180); 
 } 
 set 
 { 
 latitudeRadians = value; 
 } 
 ...
 get 
 { 
 return ((double)longitudeDegrees + ((double)longitudeMinutes / 60) + 
 ((double)longitudeSeconds / 3600)) * (Math.PI / 180); 
 } 
 set 
 { 
 longitudeRadians = value; 
 } 
 } 
 ...
 if (latitudeDegrees < 0) //display the negative value as positive 
 lat = latitudeDegrees * -1; 
 else 
 lat = latitudeDegrees; 
 
 if (longitudeDegrees < 0) //display the negative value as positive 
 lon = longitudeDegrees * -1; 
 else 
 lon = longitudeDegrees; 
 
 string s; 
 s = string.Format(lat + "°"+latitudeMinutes +"'"+latitudeSeconds+"\" "+ NShemisphere+", " 
 + lon + "°"+longitudeMinutes+"'"+longitudeSeconds+"\" "+EWhemisphere); 
 return s; 
 } 
...
{ 
 ...
 Console.WriteLine("This program calculates the distance between a"); 
 ...
 Console.WriteLine("Enter a latitude specified in DMS format."); 
 ...
 Console.WriteLine("Enter a longitude specified in DMS format."); 
 ...
 do 
 { 
 Console.WriteLine("Enter the {0} of the {1} ", 
 units, measurement); 
 Console.Write(" between 0 and {0} as an unsigned integer: ", 
 max); 
