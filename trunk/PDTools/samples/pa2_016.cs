...
{ 
 ...
 // Convert Decimal Degrees Representation to DMS Representation 
 latitudeDegrees = (int) latitude; 
 latitudeMinutes = (uint) ((latitude - latitudeDegrees)*60); 
 latitudeSeconds = (uint) ((Math.Abs((latitude - latitudeDegrees) * 60) - latitudeMinutes)*60); 
 
 longitudeDegrees = (int) longitude; 
 longitudeMinutes = (uint) ((longitude - longitudeDegrees)*60); 
 longitudeSeconds = (uint) ((Math.Abs((longitude - longitudeDegrees) * 60) - longitudeMinutes)*60); 
 } 
 ...
 get 
 { 
 return ((latitudeDegrees + (latitudeMinutes/60.0) + (latitudeSeconds/3600.0))*(Math.PI/180)); 
 } 
 ...
 get 
 { 
 return ((longitudeDegrees + (longitudeMinutes/60.0) + (longitudeSeconds/3600.0))*(Math.PI/180)); 
 } 
 } 
 ...
 latitudeDegrees, latitudeMinutes, latitudeSeconds, xcoordinate, 
 longitudeDegrees, longitudeMinutes, longitudeSeconds, ycoordinate); 
 } 
...
{ 
 ...
 } while (inputNumber < 0 || inputNumber > max); 
