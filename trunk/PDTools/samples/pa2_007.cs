...
public GeographicLocation(double latitude, double longitude) 
 ...
 if (latitudeDegrees > 0) 
 latitude = latitude - latitudeDegrees; 
 latitudeMinutes = (uint)(latitude * 60); 
 latitude = latitude - latitudeMinutes; 
 latitudeSeconds=(uint)(latitude * 60); 
 ...
 longitude = longitude - longitudeDegrees; 
 longitude = longitude - longitudeDegrees; 
 longitudeMinutes = (uint)(longitude * 60); 
 longitude = longitude - longitudeMinutes; 
 longitudeSeconds = (uint)(longitude * 60); 
...
{ 
 ...
 "Out of range longitudinal value"); 
 } 
 } 
 } 
 ...
 { 
 // This instance method should return a decimal degrees representation 
 ...
 // of radians. This method should not produce any console output. 
 ...
 output1 = string.Format("{0}\u00b0{1}'{2}\" {3},", 
 Math.Abs(latitudeDegrees), latitudeMinutes, latitudeSeconds, 
 dirlat); 
 output2 = string.Format(" {0}\u00b0{1}'{2}\" {3}", 
...
if (latDegrees == -90 || latDegrees == 90) 
 ...
 //unsignedint=stores the value of the unit entered by the user 
 uint unsignedint; 
 ...
 unsignedint = uint.Parse(Console.ReadLine()); 
 } while (unsignedint > max); 
