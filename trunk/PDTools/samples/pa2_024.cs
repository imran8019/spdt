...
{ 
 ...
 latitudeMinutes = (uint) ( latitude - (int) latitude ) * 60; 
 latitudeSeconds = (uint) (( latitude - (int) latitude ) * 60 - 
 (int) ( latitude - (int) latitude ) * 60); 
 
 longitudeDegrees = (int) longitude; 
 longitudeMinutes = (uint) ( longitude - (int) longitude ) * 60; 
 longitudeSeconds = (uint) (( longitude - (int) longitude ) * 60 - 
 (int) ( longitude - (int) longitude ) * 60); 
 } 
 ...
 get 
 { 
 return Math.PI / 180 * ((double)latitudeDegrees + 
 (double)latitudeMinutes / 60 + (double)latitudeSeconds / 3600); 
 } 
 } 
 ...
 get 
 { 
 return Math.PI / 180 * ((double)longitudeDegrees + 
 (double)longitudeMinutes / 60 + (double)longitudeSeconds / 3600); 
 } 
 } 
