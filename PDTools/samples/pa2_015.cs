...
// 
// Acknowledgements: 
// Attended Village 1 Computer Programming tutor session on 
// October 13th. Received help with first constructor and properites. 
// ------------------------------------------------------------------- 
using System; 
...
{ 
 ...
 //Calculates the dms representation of the inputed decimal 
 //representation. This constructor is not used. 
 ...
 //Assigns values to the variables latitude DMS and longitude DMS 
 ...
 //Returns the decimal degree value of latitude in radians 
 get {return ((latitudeSeconds/60.0+latitudeMinutes)/60.0 + 
 ...
 //Returns the decimal degree value of longitude in radians 
 get { return ((longitudeSeconds/60.0+longitudeMinutes)/60.0 + 
 ...
 //Creates string variables that will be used to output N E S and W 
 //Currently initialized with no characters 
 string latitude = ""; 
 string longitude = ""; 
 
 
 //If statements to determine what hemisphere the coordinates given 
 //are in. Will return a negative negative value so -W or -S does 
 //not occur in ToString method 
 if (latitudeDegrees > 0) 
 { 
 latitude = "N"; 
 } 
 else if (latitudeDegrees < 0) 
 { 
 latitude = "S"; 
 ...
 //Outputs the latitude, longitude, and hemispehere information 
 //when function is called 
 return string.Format("{0}\u00b0{1}'{2}\" {3}\t{4}\u00b0{5}'{6}\" {7}", 
 latitudeDegrees, latitudeMinutes, latitudeSeconds,latitude, 
 longitudeDegrees, longitudeMinutes, longitudeSeconds,longitude); 
 } 
...
{ 
 ...
 //Same as getIntger() method except lower limit is 0 
 //because uint does not have negative value 
 do 
 { 
 Console.WriteLine("\nEnter the {0} of the {1} ranging", 
 units, measurement); 
